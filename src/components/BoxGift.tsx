...
const BoxGridLiveItem = ({ gift }: { gift: LiveGiftMessagePayload }) => {
    const { giftNotifyBaseClass } = useSelector((state: AppState) => state.liveStreamingState);

    return (
        <div id={gift.queue_id} className={classNames(giftNotifyBaseClass, 'animate__fadeInRight')}>
