...
export default ({
    ...
    const { joinState, sendMessage, joinChat, leaveChat, errors, messages } =
    ...
    return (
        <div className="live-chat" style={{ position: 'absolute' }}>
            ...
            <div className={'chatInputWrap hide--slide-x hide--slide-y show'} id="chatInputWrap">
                <TextField
                    ...
                    InputProps={{
                        ...
                        endAdornment: (
                            <Button name="SEND" onClick={onSend} className="btn-send-chat br-5">
                                SEND
                            </Button>
                        ),
